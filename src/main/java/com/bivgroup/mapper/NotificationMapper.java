...
public interface NotificationMapper {
    ...
    NotificationResponse toNotificationResponse(GetNotificationsByContractNumberRequest request, List<Notification> notifications, Long statusCode, String statusDescription);
}
